package com.cjl.rabbit.task.parser;

import com.cjl.rabbit.task.annotation.ElasticJobConfig;
import com.cjl.rabbit.task.autoconfigure.JobZookeeperProperties;
import com.cjl.rabbit.task.enums.ElasticJobTypeEnum;
...
public class ElasticJobConfParser implements ApplicationListener<ApplicationReadyEvent> {
    ...
    public void onApplicationEvent(ApplicationReadyEvent event) {
        try {
            ...
            //从spring上下文中取出被ElasticJobConfig注解修饰过的been
            ...
            for(Iterator<?> it = beanMap.values().iterator(); it.hasNext();) {
                ...
                //	获取配置项 ElasticJobConfig , 用以配置LiteJobConfiguration
                ...
                //	先把当当网的esjob的相关configuration配置了
                ...
                //为什么使用多例？猜想:一个Scheduler使用一个been,所以需要多例
